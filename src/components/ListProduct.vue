<template>
  <section>
    <HeaderComponent :keranjang="keranjang.length" />
    <div id="Product" class="container">
      ...
      <div class="grid lg:grid-cols-3 gap-6">
        <div v-for="(listProduct, index) in product" :key="index">
          <div
            class="card grid p-5 rounded-3xl overflow-hidden shadow-xl h-full"
            v-if="listProduct.price <= Number(maksimal)"
          >
            <img
              class="mx-auto rounded-2xl w-full object-fit object-cover"
              style="height: 400px"
              height="400px"
            ...
            <div class="wrapper-content grid">
              ...
              <div class="flex items-baseline flex-wrap gap-y-3">
                ...
                <button
                  ...
                  v-on:click="addToCart(listProduct)"
                >
                  Tambah
                </button>
              </div>
